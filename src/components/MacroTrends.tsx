      ...
      <div className="bg-white rounded-[40px] p-5 md:p-8 shadow-xl shadow-blue-900/5 border border-blue-100 mb-6 md:mb-8">
        <div className="flex items-center space-x-3 md:space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-500 text-xs md:text-base font-medium">Latest available macro-economic data for Bangladesh's agricultural sector from the World Bank.</p>
          </div>
        </div>
      </div>
